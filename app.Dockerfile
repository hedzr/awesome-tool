...
LABEL com.hedzr.image.authors="hedzr <hedzr@duck.com>" \
	com.hedzr.image.description="retrieve github repo stars from an awesomeness list" \
	description="retrieve github repo stars from an awesomeness list" \
	version="$VERSION" \
	org.opencontainers.image.description="retrieve github repo stars from an awesomeness list" \
	org.opencontainers.image.author="hedzr <hedzr@duck.com>" \
	org.opencontainers.image.url="https://github.com/hedzr/awesome-tool" \
...
WORKDIR "/app"
VOLUME ["/app", "/etc/awesome-tool/conf.d", "/go/pkg", "/tmp"]
...
#USER $USER
ENTRYPOINT ["/var/lib/awesome-tool/awesome-tool"]
